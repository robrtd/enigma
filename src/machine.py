...
from factory import create_rotor, create_reflector
...
# only:
KEYBOARD_CHARS = string.ascii_uppercase[0:ALPHABET_LENGTH]
...
class EnigmaMachine:
    ...
    def _step_rotors(self):
        ...
        rotate2 = len(self.rotors) > 1 and (rotor1.notch_over_pawl() or rotor2.notch_over_pawl())
        rotate3 = len(self.rotors) > 2 and rotor2.notch_over_pawl()
